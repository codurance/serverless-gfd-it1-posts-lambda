...
aws s3 rm s3://serverless-frontend-a-s3 --recursive 
aws s3 rb s3://serverless-frontend-a-s3  
aws s3api create-bucket --bucket serverless-frontend-a-s3 --region us-east-1  
